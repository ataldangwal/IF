...
public class AdapterUserFeedback extends ArrayAdapter<Ads> {
    private int adCount;
    private Activity activity;
    private ArrayList<UserFeedback> AdComments;
    ...
    public AdapterUserFeedback(Activity activity, int textViewResourceId, ArrayList<UserFeedback> _allAdComments, Context context) {
    ...
    public void addListItemToAdapter(ArrayList<UserFeedback> list) {
    ...
    public UserFeedback getItem(UserFeedback position) {
        return position;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            holder.display_name.setText(AdComments.get(position).ReviewerUserName);
            holder.display_comment.setText(AdComments.get(position).FeedbackText);
            ...
            holder.display_name.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("Token", AdComments.get(position).ReviewerUserToken);
