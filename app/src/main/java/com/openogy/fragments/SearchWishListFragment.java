...
public class SearchWishListFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(getArguments() != null)
        {
            ...
            {
                String url = CommonFunctions.API_URL + "WishList/GetWishesForCityInSearch";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.layout_searchwishlistfragment,container,false);
        return view;
    }
